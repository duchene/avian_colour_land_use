...
# Empty interaction cell (Temperate Open x Plantation collapsed away):
# its coefficient is prior-only and is flagged, not interpreted.
...
write_csv(conv, "results/A2c_convergence.csv")
cat("Convergence:\n"); print(conv)
...
write_csv(fixef_tbl, "results/A2c_fixed_effects.csv")
...
write_csv(varcomp, "results/A2c_variance_components.csv")
cat("\nVariance components:\n"); print(varcomp)
...
write_csv(r2, "results/A2c_r2_summary.csv")
cat("\nBayesian R2:\n"); print(r2)
