...
write_csv(conv, "results/A2d_convergence.csv")
cat("Convergence:\n"); print(conv)
...
write_csv(fixef_tbl, "results/A2d_fixed_effects.csv")
...
write_csv(varcomp, "results/A2d_variance_components.csv")
cat("\nVariance components:\n"); print(varcomp)
...
write_csv(r2, "results/A2d_r2_summary.csv")
cat("\nBayesian R2:\n"); print(r2)
