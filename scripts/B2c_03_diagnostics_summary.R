...
write_csv(conv, "results/B2c_convergence.csv")
cat("Convergence:\n"); print(conv)
...
write_csv(fixef_tbl, "results/B2c_fixed_effects.csv")
...
write_csv(varcomp, "results/B2c_variance_components.csv")
cat("\nVariance components:\n"); print(varcomp)
...
write_csv(r2, "results/B2c_r2_summary.csv")
cat("\nBayesian R2:\n"); print(r2)
