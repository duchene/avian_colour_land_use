# ============================================================
# A1a_01_setup.R
# Analysis 1a: A1b plus land-use x trophic niche and land-use x
#              body mass interactions (NO phylogeny, same rationale).
#
# A1a is a clean nested SUPERSET of the A1b covariate model:
#
...
#
# Same rows, priors, sampler and random structure as A1b (both call
# load_community_data()), so the A1a_03 LOO directly tests whether
# guild- and size-specific land-use responses add predictive value.
# Biome x land use is reported from A1b; A1a contributes the
# trophic/mass story.
# ============================================================
