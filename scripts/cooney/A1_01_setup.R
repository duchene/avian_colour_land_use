# ============================================================
# A1_01_setup.R
# Analysis 1: Phylogenetic regression of species-level colour on
...
priors_A1          <- model_priors("phylo_lognormal")
priors_A1_gaussian <- model_priors("phylo_gaussian")

dir.create("fits", showWarnings = FALSE)
save(spdat, responses, lu_predictors, priors_A1, priors_A1_gaussian,
     response_families, nthreads, A, tree,
     file = "fits/A1_model_setup.RData")
cat("\nA1 setup complete. Saved to fits/A1_model_setup.RData\n")
