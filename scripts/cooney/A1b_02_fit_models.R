# ============================================================
# A1b_02_fit_models.R
# Fit A1b models: 4 responses x {base, covariate} = 8 models.
...
fit_one <- function(resp, variant) {
  ...
  f    <- paste0("fits/A1b_fit_", tag, ".RData")
...
save(fits, file = "fits/A1b_all_fits.RData")
cat("\nAll A1b fits complete. Saved to fits/A1b_all_fits.RData\n")
