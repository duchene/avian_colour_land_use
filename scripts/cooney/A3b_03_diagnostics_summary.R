# ============================================================
# A3b_03_diagnostics_summary.R
# Convergence, fixed effects, and Bayesian R2 for the A3b models.
# Outputs: results/A3b_convergence.csv, A3b_fixed_effects.csv,
#          results/A3b_r2_summary.csv
# ============================================================
...
write_csv(conv, "results/cooney/A3b_convergence.csv")
cat("Convergence:\n"); print(conv)
...
write_csv(fixef_tbl, "results/cooney/A3b_fixed_effects.csv")

r2 <- map_dfr(names(fits), function(tag) {
  r <- bayes_R2(fits[[tag]])
  tibble(model = tag, R2 = r[, "Estimate"], Q2.5 = r[, "Q2.5"], Q97.5 = r[, "Q97.5"])
})
write_csv(r2, "results/cooney/A3b_r2_summary.csv")
cat("\nBayesian R2:\n"); print(r2)

cat("\nA3b diagnostics complete. Tables in results/.\n")
