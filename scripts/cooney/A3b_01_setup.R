# ============================================================
# A3b_01_setup.R
# Analysis 3b: Community colour/dichromatism ~ biome x land use
...
#
# A3b is the primary community-colour model. Biome x land use is
# reported from here.
# ============================================================
...
# only; the land-use interactions with them are A3a's job.
...
save(dat, responses, response_families, formulas,
     ...
     file = "fits/A3b_model_setup.RData")
cat("\nA3b setup complete. Saved to fits/A3b_model_setup.RData\n")
