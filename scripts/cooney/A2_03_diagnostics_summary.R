...
print(diag_summary)
write_csv(diag_summary, "results/cooney/A2_convergence.csv")
...
cat(rep("=", 60), "\n")
print(r2_summary)
write_csv(r2_summary, "results/cooney/A2_r2_summary.csv")
...
write_csv(fixed_effects, "results/cooney/A2_fixed_effects.csv")
...
for (cv in names(fits_A2)) {
  ...
  ggsave(paste0("figures/cooney/A2_pp_check_", cv, ".png"), p,
...
for (cv in names(fits_A2)) {
  ...
  ggsave(paste0("figures/cooney/A2_conditional_", cv, ".png"), p,
...
for (cv in names(fits_A2)) {
  ...
  ggsave(paste0("figures/cooney/A2_forest_", cv, ".png"), p,
...
ggsave("figures/cooney/A2_colour_comparison.png", p_compare,
       width = 7, height = 4, dpi = 150)
