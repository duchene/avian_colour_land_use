# ============================================================
# B2c_01_setup.R
# Analysis B2c: Dale-colour counterpart of A2c.
# Relative abundance ~ colour x biome x land-use (2-way; phylogenetic).
#
# Identical to A2c in data, phylogenetic matching, priors, sampler and
# random structure. The only difference is the colour predictors:
# z_malecoldale and z_dichrodiffdale (Dale) in place of the Cooney
# z_malecolcooney and z_dichrodiff. Colour enters standardised, so the
# predictor scale is identical regardless of source.
# ============================================================
...
# ------------------------------------------------------------
dat <- dat %>% mutate(z_malecoldale   = zscore(malecoldale),
...
priors_B2c <- c(prior(normal(0, 2),   class = "Intercept"),
