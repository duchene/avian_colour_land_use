# ============================================================
# B3b_02_fit_models.R
# Fit B3b models: 4 Dale responses x {base, covariate} = 8 models.
# No phylogeny. Mirrors A3b_02.
# ============================================================
...
load("fits/B3b_model_setup.RData")
...
fit_one <- function(resp, variant) {
  ...
  f    <- paste0("fits/B3b_fit_", tag, ".RData")
...
save(fits, file = "fits/B3b_all_fits.RData")
cat("\nAll B3b fits complete. Saved to fits/B3b_all_fits.RData\n")
