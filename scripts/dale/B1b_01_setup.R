# ============================================================
# B1b_01_setup.R
# Dale-colour counterpart of A1b.
#
# Identical to A1b in data, priors, sampler and random structure.
# The only difference is the colour source: the four Dale et al.
# (2015) plumage metrics in place of the Cooney UVS metrics.
# B1b is the primary community model of the Dale (B) family and the
# reduced model in the B1a LOO.
# ============================================================
