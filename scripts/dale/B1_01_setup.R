...
priors_B1          <- model_priors("phylo_lognormal")
priors_B1_gaussian <- model_priors("phylo_gaussian")

dir.create("fits", showWarnings = FALSE)
save(spdat, responses, lu_predictors, priors_B1, priors_B1_gaussian,
     response_families, nthreads, A, tree,
     file = "fits/B1_model_setup.RData")
cat("\nB1 setup complete. Saved to fits/B1_model_setup.RData\n")
