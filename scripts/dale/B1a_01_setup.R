# ============================================================
# B1a_01_setup.R
# Analysis B1a: Dale-colour counterpart of A1a.
# Community colour/dichromatism ~ biome x land-use PLUS
# land-use x trophic niche and land-use x body mass (no phylogeny).
#
# Identical to A1a in data, collapse, priors, sampler and random
# structure. The only difference is the colour source: the four Dale
# metrics (Dale et al. 2015) in place of the Cooney UVS metrics. B1a
# is a nested superset of B1b (LOO in B1a_03 tests the guild/size
# interactions), exactly as A1a relates to A1b.
# ============================================================
...
# ------------------------------------------------------------
# DATA  (identical prep to A1a_01_setup.R)
# ------------------------------------------------------------
