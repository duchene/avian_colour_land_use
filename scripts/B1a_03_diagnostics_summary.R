...
write_csv(conv, "results/B1a_convergence.csv")
cat("Convergence:\n"); print(conv)
...
write_csv(fixef_tbl, "results/B1a_fixed_effects.csv")
...
write_csv(r2, "results/B1a_r2_summary.csv")
cat("\nBayesian R2:\n"); print(r2)
...
if (nrow(loo_tbl)) {
  write_csv(loo_tbl, "results/B1a_vs_B1b_loo.csv")
