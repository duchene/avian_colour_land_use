...
print(diag_summary)
write_csv(diag_summary, "results/A3_convergence.csv")
...
write_csv(r2_summary, "results/A3_r2_summary.csv")
...
write_csv(fixed_effects, "results/A3_fixed_effects.csv")
...
for (resp in names(fits_A3)) {
  ...
  ggsave(paste0("figures/A3_forest_", resp, ".png"), p,
...
for (resp in names(fits_A3)) {
  ...
  ggsave(paste0("figures/A3_pp_check_", resp, ".png"), p,
